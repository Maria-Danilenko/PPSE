...
namespace WebApplication4
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connection = "Server=DESKTOP-GF8REUK\\SQLEXPRESS;Database=Pizza;Trusted_Connection=true;Encrypt=False";
            services.AddDbContext<PizzasContext>(options => options.UseSqlServer(connection));
